...
<div class="row">
    ...
    <div>
        ...
        <div class="pt-4 font-weight-bold">Student | Software Engineer | Hobbyist</div>
        <div>Vikram Pathalam is a current student at Northeastern pursuing a B.S. in Computer Science</div>
        <div><a href="vikrampathalam.now.sh" target="_blank">Visit Personal Website</a></div>
    </div>
    <div class="row pt-4">
